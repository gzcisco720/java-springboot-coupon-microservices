package com.spring.coupon.serialization;
...
public class CouponTemplateSerialize extends JsonSerializer<CouponTemplate> {
    ...
    public void serialize(CouponTemplate couponTemplate,
        ...
        jsonGenerator.writeStringField("createTime", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(couponTemplate.getCreatedTime()));
